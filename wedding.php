...
Gardenia</h2>
			<ul style="margin-right: 500px; font-size: 20px;">
				...
				<li><a href="public events.php" style="color:#b300b3;">public events</a></li>
				<li><a href="special.php" style="color:#ff0080;">special</a></li>
...
<form action="" method="post">
	...
	<div class="product">
		<div>
			<div class="card">
				<img src="admin/wedding_img/<?php echo $fetch_product['image']; ?>" >
			</div>
